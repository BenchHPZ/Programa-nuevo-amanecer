/**
 * Catálogo de estados y municipios de México, para el menú desplegable en
 * cascada de "Estado"/"Municipio" (sección D). Los 32 estados de la
 * república, con sus nombres de uso común (p. ej. "Coahuila", no
 * "Coahuila de Zaragoza") en vez de la forma larga oficial del INEGI —
 * son estos los que reconoce quien está llenando el formulario.
 *
 * "Extranjero" se agrega aparte como los 33: no tiene municipios, y su
 * sola presencia en ESTADOS_MEXICO es lo que el formulario usa para saber
 * cuándo deshabilitar el campo de municipio.
 *
 * Municipios tomados del Catálogo Único de Claves de Áreas
 * Geoestadísticas Estatales, Municipales y Localidades (INEGI, AGEEML).
 */

export const EXTRANJERO = "Extranjero" as const;
...
export const MUNICIPIOS_POR_ESTADO: Record<Exclude<EstadoMexico, typeof EXTRANJERO>, readonly string[]> = {
  "Aguascalientes": [
    "Aguascalientes",
    "Asientos",
    "Calvillo",
